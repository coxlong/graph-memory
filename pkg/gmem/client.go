...
var indexQueries = []string{
	...
	"CALL db.idx.fulltext.createNodeIndex({label:'Entity'}, 'name', 'summary', 'group_id')",
	"CALL db.idx.fulltext.createNodeIndex({label:'Episodic'}, 'content', 'source', 'source_description', 'group_id')",
